        ...
        <div className="space-y-12 pb-24 animate-in fade-in duration-500">
            ...
            <SortableList
                ...
                renderItem={(item) => {
                    ...
                    const title = item.nameEn || item.nameEs || item.nameFr || 'Untitled Project';
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="col-span-2">
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 border-l-2 border-indigo-500/20 pl-4 py-1">
                                                {(['En', 'Es', 'Fr'] as const).map(l => (
                                                    <div key={l} className="space-y-1">
                                                        <label className="text-[10px] text-gray-400 font-medium uppercase tracking-wider">Project Name ({l})</label>
                                                        <input
                                                            value={item[`name${l}`] || ''}
                                                            onChange={(e) => sectHook.updateEntry(item.id, `name${l}`, e.target.value)}
